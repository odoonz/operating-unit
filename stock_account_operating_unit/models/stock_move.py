...
class StockMove(models.Model):
    ...
    def _get_transaction_ou(self):
        ...
        return self.operating_unit_id or self.operating_unit_dest_id or self.picking_id.operating_unit_id
    ...
    def _prepare_account_move_line(self, qty, cost, credit_account_id,
        ...
        inventory_ou = self.operating_unit_id or self.location_id.operating_unit_id or self.location_dest_id.operating_unit_id or self.sale_line_id.operating_unit_id or self.picking_id.operating_unit_id
